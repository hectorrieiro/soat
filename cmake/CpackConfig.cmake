...
set(CPACK_PACKAGE_NAME "Analysis")

if(APPLE)
  set(CPACK_PACKAGE_VENDOR "Saccadous") # PackageMaker doesn't like http://
else()
  set(CPACK_PACKAGE_VENDOR "http://saccadous.com") # deb lintian insists on URL
endif()

set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Reports for EM stimulation")
set(CPACK_PACKAGE_CONTACT "Hector Rieiro <hector@saccadous.com>")
